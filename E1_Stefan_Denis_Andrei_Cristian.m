...
%Fie vectorii linie a=[0,0.1,0.2, ,2] si coloana b=[1...1]
 %a) Ce lungime trebuie sa aiba b astfel ca sa aiba sens înmultirea 
%(în sens matricial) a*b? Ini?ializa?i în MATLAB cei doi vectori si 
%realizati înmultirea. Ce operatie se efectueaza? 
%b) Realizati înmultirea b*a. 
%c) Realizati înmultirea element cu element a celor doi vectori. 
